...
std::vector<std::shared_ptr<c_player>> c_world::get_players()
{
	...
	static jclass list_cls = gasper::instance->get_env()->FindClass(xorstr_("java/util/List"));
	static jmethodID to_array_md = gasper::instance->get_env()->GetMethodID(list_cls, xorstr_("toArray"), xorstr_("()[Ljava/lang/Object;"));
